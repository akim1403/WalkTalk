    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new FetchURL(DirectionReco.this).execute(getUrl(place2.getPosition(), place3.getPosition(), "walking"),
                        "walking");
            }
        });
    ...
    public String[] getWalks(double[] locationMinMax) throws Exception {
        ...
        for (int i = 0; i < WalkList.size(); i++) {
            ...
            if (Double.parseDouble(locationDetails[0]) == locationMinMax[0]
                    && Double.parseDouble(locationDetails[1]) == locationMinMax[1]) {
                if (Double.parseDouble(endLocationDetails[0]) == locationMinMax[2]
                        && Double.parseDouble(endLocationDetails[1]) == locationMinMax[3]) {
                    ...
                    Log.d("myTag",
                            "returning " + walkDetails[0] + walkDetails[1] + locationDetails[0] + locationDetails[1]
