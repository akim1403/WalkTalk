    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startAudio("chinese");
                new FetchURL(DirectionActivityNonChinese.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "walking"), "walking");
            }
        });
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new FetchURL(DirectionActivityNonChinese.this).execute(getUrl(place2.getPosition(), place3.getPosition(), "walking"), "walking");
            }
        });
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    place2 = new MarkerOptions().position(new LatLng(38.86860801450304, 121.53456197968475)).title("Location 2");
                    new FetchURL(DirectionActivityNonChinese.this).execute(getUrl(place3.getPosition(), place1.getPosition(), "walking"), "walking");
